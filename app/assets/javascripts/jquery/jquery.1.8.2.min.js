(function(s,p){function Db(a){var b=Aa[a]={};return c.each(a.split(L),function(a,c){b[c]=!0}),b}function Ba(a,b,d){if(d===p&&1===a.nodeType)if(d="data-"+b.replace(Eb,"-$1").toLowerCase(),d=a.getAttribute(d),"string"==typeof d){try{d="true"===d?!0:"false"===d?!1:"null"===d?null:+d+""===d?+d:Fb.test(d)?c.parseJSON(d):d}catch(e){}c.data(a,b,d)}else d=p;return d}function na(a){for(var b in a)if(("data"!==b||!c.isEmptyObject(a[b]))&&"toJSON"!==b)return!1;return!0}function R(){return!1}function N(){return!0}
...
"undefined"!=typeof a.querySelectorAll?a.querySelectorAll("*"):[]}function Ja(a){Ia.test(a.type)&&(a.defaultChecked=a.checked)}function Ka(a,b){if(b in a)return b;for(var d=b.charAt(0).toUpperCase()+b.slice(1),c=b,f=La.length;f--;)if(b=La[f]+d,b in a)return b;return c}function ba(a,b){return a=b||a,"none"===c.css(a,"display")||!c.contains(a.ownerDocument,a)}function Ma(a,b){for(var d,e,f=[],g=0,h=a.length;g<h;g++)d=a[g],d.style&&(f[g]=c._data(d,"olddisplay"),b?(!f[g]&&"none"===d.style.display&&(d.style.display=
""),""===d.style.display&&ba(d)&&(f[g]=c._data(d,"olddisplay",Na(d.nodeName)))):(e=v(d,"display"),!f[g]&&"none"!==e&&c._data(d,"olddisplay",e)));for(g=0;g<h;g++)d=a[g],!d.style||b&&"none"!==d.style.display&&""!==d.style.display||(d.style.display=b?f[g]||"":"none");return a}function Oa(a,b,d){return(a=Hb.exec(b))?Math.max(0,a[1]-(d||0))+(a[2]||"px"):b}function Pa(a,b,d,e){b=d===(e?"border":"content")?4:"width"===b?1:0;for(var f=0;4>b;b+=2)"margin"===d&&(f+=c.css(a,d+G[b],!0)),e?("content"===d&&(f-=
parseFloat(v(a,"padding"+G[b]))||0),"margin"!==d&&(f-=parseFloat(v(a,"border"+G[b]+"Width"))||0)):(f+=parseFloat(v(a,"padding"+G[b]))||0,"padding"!==d&&(f+=parseFloat(v(a,"border"+G[b]+"Width"))||0));return f}function Qa(a,b,d){var e="width"===b?a.offsetWidth:a.offsetHeight,f=!0,g=c.support.boxSizing&&"border-box"===c.css(a,"boxSizing");if(0>=e||null==e){e=v(a,b);if(0>e||null==e)e=a.style[b];if(Y.test(e))return e;f=g&&(c.support.boxSizingReliable||e===a.style[b]);e=parseFloat(e)||0}return e+Pa(a,
b,d||(g?"border":"content"),f)+"px"}function Na(a){if(oa[a])return oa[a];var b=c("<"+a+">").appendTo(q.body),d=b.css("display");b.remove();if("none"===d||""===d)S=q.body.appendChild(S||c.extend(q.createElement("iframe"),{frameBorder:0,width:0,height:0})),T&&S.createElement||(T=(S.contentWindow||S.contentDocument).document,T.write("<!doctype html><html><body>"),T.close()),b=T.body.appendChild(T.createElement(a)),d=v(b,"display"),q.body.removeChild(S);return oa[a]=d,d}function pa(a,b,d,e){var f;if(c.isArray(b))c.each(b,
function(b,c){d||Ib.test(a)?e(a,c):pa(a+"["+("object"==typeof c?b:"")+"]",c,d,e)});else if(d||"object"!==c.type(b))e(a,b);else for(f in b)pa(a+"["+f+"]",b[f],d,e)}function Ra(a){return function(b,d){"string"!=typeof b&&(d=b,b="*");var e,f,g=b.toLowerCase().split(L),h=0,k=g.length;if(c.isFunction(d))for(;h<k;h++)e=g[h],(f=/^\+/.test(e))&&(e=e.substr(1)||"*"),e=a[e]=a[e]||[],e[f?"unshift":"push"](d)}}function ca(a,b,d,c,f,g){f=f||b.dataTypes[0];g=g||{};g[f]=!0;var h;f=a[f];for(var k=0,l=f?f.length:
0,n=a===qa;k<l&&(n||!h);k++)h=f[k](b,d,c),"string"==typeof h&&(!n||g[h]?h=p:(b.dataTypes.unshift(h),h=ca(a,b,d,c,h,g)));return(n||!h)&&!g["*"]&&(h=ca(a,b,d,c,"*",g)),h}function Sa(a,b){var d,e,f=c.ajaxSettings.flatOptions||{};for(d in b)b[d]!==p&&((f[d]?a:e||(e={}))[d]=b[d]);e&&c.extend(!0,a,e)}function Ta(){try{return new s.XMLHttpRequest}catch(a){}}function Ua(){return setTimeout(function(){da=p},0),da=c.now()}function Jb(a,b){c.each(b,function(b,c){for(var f=(Z[b]||[]).concat(Z["*"]),g=0,h=f.length;g<
h&&!f[g].call(a,b,c);g++);})}function Va(a,b,d){var e=0,f=fa.length,g=c.Deferred().always(function(){delete h.elem}),h=function(){for(var b=da||Ua(),b=Math.max(0,k.startTime+k.duration-b),d=1-(b/k.duration||0),c=0,e=k.tweens.length;c<e;c++)k.tweens[c].run(d);return g.notifyWith(a,[k,d,b]),1>d&&e?b:(g.resolveWith(a,[k]),!1)},k=g.promise({elem:a,props:c.extend({},b),opts:c.extend(!0,{specialEasing:{}},d),originalProperties:b,originalOptions:d,startTime:da||Ua(),duration:d.duration,tweens:[],createTween:function(b,
d,e){b=c.Tween(a,k.opts,b,d,k.opts.specialEasing[b]||k.opts.easing);return k.tweens.push(b),b},stop:function(b){for(var d=0,c=b?k.tweens.length:0;d<c;d++)k.tweens[d].run(1);return b?g.resolveWith(a,[k,b]):g.rejectWith(a,[k,b]),this}});d=k.props;for(Kb(d,k.opts.specialEasing);e<f;e++)if(b=fa[e].call(k,a,d,k.opts))return b;return Jb(k,d),c.isFunction(k.opts.start)&&k.opts.start.call(a,k),c.fx.timer(c.extend(h,{anim:k,queue:k.opts.queue,elem:a})),k.progress(k.opts.progress).done(k.opts.done,k.opts.complete).fail(k.opts.fail).always(k.opts.always)}
function Kb(a,b){var d,e,f,g,h;for(d in a)if(e=c.camelCase(d),f=b[e],g=a[d],c.isArray(g)&&(f=g[1],g=a[d]=g[0]),d!==e&&(a[e]=g,delete a[d]),(h=c.cssHooks[e])&&"expand"in h)for(d in g=h.expand(g),delete a[e],g)d in a||(a[d]=g[d],b[d]=f);else b[e]=f}function C(a,b,d,c,f){return new C.prototype.init(a,b,d,c,f)}function ga(a,b){var d,c={height:a},f=0;for(b=b?1:0;4>f;f+=2-b)d=G[f],c["margin"+d]=c["padding"+d]=a;return b&&(c.opacity=c.width=a),c}function Wa(a){return c.isWindow(a)?a:9===a.nodeType?a.defaultView||
a.parentWindow:!1}var Xa,ha,q=s.document,Lb=s.location,Mb=s.navigator,Nb=s.jQuery,Ob=s.$,Ya=Array.prototype.push,x=Array.prototype.slice,Za=Array.prototype.indexOf,Pb=Object.prototype.toString,ra=Object.prototype.hasOwnProperty,sa=String.prototype.trim,c=function(a,b){return new c.fn.init(a,b,Xa)},ia=/[\-+]?(?:\d*\.|)\d+(?:[eE][\-+]?\d+|)/.source,Qb=/\S/,L=/\s+/,Rb=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,Sb=/^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/,$a=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,Tb=/^[\],:{}\s]*$/,
Ub=/(?:^|:|,)(?:\s*\[)+/g,Vb=/\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g,Wb=/"[^"\\\r\n]*"|true|false|null|-?(?:\d\d*\.|)\d+(?:[eE][\-+]?\d+|)/g,Xb=/^-ms-/,Yb=/-([\da-z])/gi,Zb=function(a,b){return(b+"").toUpperCase()},ja=function(){q.addEventListener?(q.removeEventListener("DOMContentLoaded",ja,!1),c.ready()):"complete"===q.readyState&&(q.detachEvent("onreadystatechange",ja),c.ready())},ab={};c.fn=c.prototype={constructor:c,init:function(a,b,d){var e,f;if(!a)return this;if(a.nodeType)return this.context=
...
p&&(h[b]=e));return h};c.extend({noConflict:function(a){return s.$===c&&(s.$=Ob),a&&s.jQuery===c&&(s.jQuery=Nb),c},isReady:!1,readyWait:1,holdReady:function(a){a?c.readyWait++:c.ready(!0)},ready:function(a){if(!0===a?!--c.readyWait:!c.isReady){if(!q.body)return setTimeout(c.ready,1);c.isReady=!0;!0!==a&&0<--c.readyWait||(ha.resolveWith(q,[c]),c.fn.trigger&&c(q).trigger("ready").off("ready"))}},isFunction:function(a){return"function"===c.type(a)},isArray:Array.isArray||function(a){return"array"===
c.type(a)},isWindow:function(a){return null!=a&&a==a.window},isNumeric:function(a){return!isNaN(parseFloat(a))&&isFinite(a)},type:function(a){return null==a?String(a):ab[Pb.call(a)]||"object"},isPlainObject:function(a){if(!a||"object"!==c.type(a)||a.nodeType||c.isWindow(a))return!1;try{if(a.constructor&&!ra.call(a,"constructor")&&!ra.call(a.constructor.prototype,"isPrototypeOf"))return!1}catch(b){return!1}for(var d in a);return d===p||ra.call(a,d)},isEmptyObject:function(a){for(var b in a)return!1;
return!0},error:function(a){throw Error(a);},parseHTML:function(a,b,d){var e;return a&&"string"==typeof a?("boolean"==typeof b&&(d=b,b=0),b=b||q,(e=$a.exec(a))?[b.createElement(e[1])]:(e=c.buildFragment([a],b,d?null:[]),c.merge([],(e.cacheable?c.clone(e.fragment):e.fragment).childNodes))):null},parseJSON:function(a){if(!a||"string"!=typeof a)return null;a=c.trim(a);if(s.JSON&&s.JSON.parse)return s.JSON.parse(a);if(Tb.test(a.replace(Vb,"@").replace(Wb,"]").replace(Ub,"")))return(new Function("return "+
a))();c.error("Invalid JSON: "+a)},parseXML:function(a){var b,d;if(!a||"string"!=typeof a)return null;try{s.DOMParser?(d=new DOMParser,b=d.parseFromString(a,"text/xml")):(b=new ActiveXObject("Microsoft.XMLDOM"),b.async="false",b.loadXML(a))}catch(e){b=p}return(!b||!b.documentElement||b.getElementsByTagName("parsererror").length)&&c.error("Invalid XML: "+a),b},noop:function(){},globalEval:function(a){a&&Qb.test(a)&&(s.execScript||function(a){s.eval.call(s,a)})(a)},camelCase:function(a){return a.replace(Xb,
"ms-").replace(Yb,Zb)},nodeName:function(a,b){return a.nodeName&&a.nodeName.toLowerCase()===b.toLowerCase()},each:function(a,b,d){var e,f=0,g=a.length,h=g===p||c.isFunction(a);if(d)if(h)for(e in a){if(!1===b.apply(a[e],d))break}else for(;f<g&&!1!==b.apply(a[f++],d););else if(h)for(e in a){if(!1===b.call(a[e],e,a[e]))break}else for(;f<g&&!1!==b.call(a[f],f,a[f++]););return a},trim:sa&&!sa.call("\ufeff ")?function(a){return null==a?"":sa.call(a)}:function(a){return null==a?"":(a+"").replace(Rb,"")},
...
e.concat(x.call(arguments)))},f.guid=a.guid=a.guid||c.guid++,f):p},access:function(a,b,d,e,f,g,h){var k,l=null==d,n=0,r=a.length;if(d&&"object"==typeof d){for(n in d)c.access(a,b,n,d[n],1,g,e);f=1}else if(e!==p){k=h===p&&c.isFunction(e);l&&(k?(k=b,b=function(a,b,d){return k.call(c(a),d)}):(b.call(a,e),b=null));if(b)for(;n<r;n++)b(a[n],d,k?e.call(a[n],n,b(a[n],d)):e,h);f=1}return f?a:l?b.call(a):r?b(a[0],d):g},now:function(){return(new Date).getTime()}});c.ready.promise=function(a){if(!ha)if(ha=c.Deferred(),
"complete"===q.readyState)setTimeout(c.ready,1);else if(q.addEventListener)q.addEventListener("DOMContentLoaded",ja,!1),s.addEventListener("load",c.ready,!1);else{q.attachEvent("onreadystatechange",ja);s.attachEvent("onload",c.ready);var b=!1;try{b=null==s.frameElement&&q.documentElement}catch(d){}b&&b.doScroll&&function f(){if(!c.isReady){try{b.doScroll("left")}catch(a){return setTimeout(f,50)}c.ready()}}()}return ha.promise(a)};c.each("Boolean Number String Function Array Date RegExp Object".split(" "),
function(a,b){ab["[object "+b+"]"]=b.toLowerCase()});Xa=c(q);var Aa={};c.Callbacks=function(a){a="string"==typeof a?Aa[a]||Db(a):c.extend({},a);var b,d,e,f,g,h,k=[],l=!a.once&&[],n=function(c){b=a.memory&&c;d=!0;h=f||0;f=0;g=k.length;for(e=!0;k&&h<g;h++)if(!1===k[h].apply(c[0],c[1])&&a.stopOnFalse){b=!1;break}e=!1;k&&(l?l.length&&n(l.shift()):b?k=[]:r.disable())},r={add:function(){if(k){var d=k.length;(function H(b){c.each(b,function(b,d){var e=c.type(d);"function"!==e||a.unique&&r.has(d)?d&&d.length&&
"string"!==e&&H(d):k.push(d)})})(arguments);e?g=k.length:b&&(f=d,n(b))}return this},remove:function(){return k&&c.each(arguments,function(a,b){for(var d;-1<(d=c.inArray(b,k,d));)k.splice(d,1),e&&(d<=g&&g--,d<=h&&h--)}),this},has:function(a){return-1<c.inArray(a,k)},empty:function(){return k=[],this},disable:function(){return k=l=b=p,this},disabled:function(){return!k},lock:function(){return l=p,b||r.disable(),this},locked:function(){return!l},fireWith:function(a,b){return b=b||[],b=[a,b.slice?b.slice():
b],k&&(!d||l)&&(e?l.push(b):n(b)),this},fire:function(){return r.fireWith(this,arguments),this},fired:function(){return!!d}};return r};c.extend({Deferred:function(a){var b=[["resolve","done",c.Callbacks("once memory"),"resolved"],["reject","fail",c.Callbacks("once memory"),"rejected"],["notify","progress",c.Callbacks("memory")]],d="pending",e={state:function(){return d},always:function(){return f.done(arguments).fail(arguments),this},then:function(){var a=arguments;return c.Deferred(function(d){c.each(b,
function(b,e){var n=e[0],r=a[b];f[e[1]](c.isFunction(r)?function(){var a=r.apply(this,arguments);a&&c.isFunction(a.promise)?a.promise().done(d.resolve).fail(d.reject).progress(d.notify):d[n+"With"](this===f?d:this,[a])}:d[n])});a=null}).promise()},promise:function(a){return null!=a?c.extend(a,e):e}},f={};return e.pipe=e.then,c.each(b,function(a,c){var k=c[2],l=c[3];e[c[1]]=k.add;l&&k.add(function(){d=l},b[a^1][2].disable,b[2][2].lock);f[c[0]]=k.fire;f[c[0]+"With"]=k.fireWith}),e.promise(f),a&&a.call(f,
...
f,g,h,k,l=q.createElement("div");l.setAttribute("className","t");l.innerHTML="  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>";b=l.getElementsByTagName("*");d=l.getElementsByTagName("a")[0];d.style.cssText="top:1px;float:left;opacity:.5";if(!b||!b.length)return{};e=q.createElement("select");f=e.appendChild(q.createElement("option"));b=l.getElementsByTagName("input")[0];a={leadingWhitespace:3===l.firstChild.nodeType,tbody:!l.getElementsByTagName("tbody").length,htmlSerialize:!!l.getElementsByTagName("link").length,
...
a.boxSizing=4===c.offsetWidth,a.doesNotIncludeMarginInBodyOffset=1!==f.offsetTop,s.getComputedStyle&&(a.pixelPosition="1%"!==(s.getComputedStyle(c,null)||{}).top,a.boxSizingReliable="4px"===(s.getComputedStyle(c,null)||{width:"4px"}).width,e=q.createElement("div"),e.style.cssText=c.style.cssText="padding:0;margin:0;border:0;display:block;overflow:hidden;",e.style.marginRight=e.style.width="0",c.style.width="1px",c.appendChild(e),a.reliableMarginRight=!parseFloat((s.getComputedStyle(e,null)||{}).marginRight)),
...
if(d!==p){if(null===d){c.removeAttr(a,b);return}return g&&"set"in g&&e&&(f=g.set(a,d,b))!==p?f:(a.setAttribute(b,d+""),d)}return g&&"get"in g&&e&&null!==(f=g.get(a,b))?f:(f=a.getAttribute(b),null===f?p:f)}},removeAttr:function(a,b){var d,e,f,g,h=0;if(b&&1===a.nodeType)for(e=b.split(L);h<e.length;h++)(f=e[h])&&(d=c.propFix[f]||f,g=eb.test(f),g||c.attr(a,f,""),a.removeAttribute(fb?f:d),g&&d in a&&(a[d]=!1))},attrHooks:{type:{set:function(a,b){if(ac.test(a.nodeName)&&a.parentNode)c.error("type property can't be changed");
else if(!c.support.radioValue&&"radio"===b&&c.nodeName(a,"input")){var d=a.value;return a.setAttribute("type",b),d&&(a.value=d),b}}},value:{get:function(a,b){return y&&c.nodeName(a,"button")?y.get(a,b):b in a?a.value:null},set:function(a,b,d){if(y&&c.nodeName(a,"button"))return y.set(a,b,d);a.value=b}}},propFix:{tabindex:"tabIndex",readonly:"readOnly","for":"htmlFor","class":"className",maxlength:"maxLength",cellspacing:"cellSpacing",cellpadding:"cellPadding",rowspan:"rowSpan",colspan:"colSpan",usemap:"useMap",
frameborder:"frameBorder",contenteditable:"contentEditable"},prop:function(a,b,d){var e,f,g,h=a.nodeType;if(a&&3!==h&&8!==h&&2!==h)return g=1!==h||!c.isXMLDoc(a),g&&(b=c.propFix[b]||b,f=c.propHooks[b]),d!==p?f&&"set"in f&&(e=f.set(a,d,b))!==p?e:a[b]=d:f&&"get"in f&&null!==(e=f.get(a,b))?e:a[b]},propHooks:{tabIndex:{get:function(a){var b=a.getAttributeNode("tabindex");return b&&b.specified?parseInt(b.value,10):bc.test(a.nodeName)||cc.test(a.nodeName)&&a.href?0:p}}}});bb={get:function(a,b){var d,e=
c.prop(a,b);return!0===e||"boolean"!=typeof e&&(d=a.getAttributeNode(b))&&!1!==d.nodeValue?b.toLowerCase():p},set:function(a,b,d){var e;return!1===b?c.removeAttr(a,d):(e=c.propFix[d]||d,e in a&&(a[e]=!0),a.setAttribute(d,d.toLowerCase())),d}};fb||(cb={name:!0,id:!0,coords:!0},y=c.valHooks.button={get:function(a,b){var c;return c=a.getAttributeNode(b),c&&(cb[b]?""!==c.value:c.specified)?c.value:p},set:function(a,b,c){var e=a.getAttributeNode(c);return e||(e=q.createAttribute(c),a.setAttributeNode(e)),
e.value=b+""}},c.each(["width","height"],function(a,b){c.attrHooks[b]=c.extend(c.attrHooks[b],{set:function(a,c){if(""===c)return a.setAttribute(b,"auto"),c}})}),c.attrHooks.contenteditable={get:y.get,set:function(a,b,c){""===b&&(b="false");y.set(a,b,c)}});c.support.hrefNormalized||c.each(["href","src","width","height"],function(a,b){c.attrHooks[b]=c.extend(c.attrHooks[b],{get:function(a){a=a.getAttribute(b,2);return null===a?p:a}})});c.support.style||(c.attrHooks.style={get:function(a){return a.style.cssText.toLowerCase()||
p},set:function(a,b){return a.style.cssText=b+""}});c.support.optSelected||(c.propHooks.selected=c.extend(c.propHooks.selected,{get:function(a){a=a.parentNode;return a&&(a.selectedIndex,a.parentNode&&a.parentNode.selectedIndex),null}}));c.support.enctype||(c.propFix.enctype="encoding");c.support.checkOn||c.each(["radio","checkbox"],function(){c.valHooks[this]={get:function(a){return null===a.getAttribute("value")?"on":a.value}}});c.each(["radio","checkbox"],function(){c.valHooks[this]=c.extend(c.valHooks[this],
{set:function(a,b){if(c.isArray(b))return a.checked=0<=c.inArray(c(a).val(),b)}})});var ta=/^(?:textarea|input|select)$/i,gb=/^([^\.]*|)(?:\.(.+)|)$/,dc=/(?:^|\s)hover(\.\S+|)\b/,ec=/^key/,fc=/^(?:mouse|contextmenu)|click/,hb=/^(?:focusinfocus|focusoutblur)$/,ib=function(a){return c.event.special.hover?a:a.replace(dc,"mouseenter$1 mouseleave$1")};c.event={add:function(a,b,d,e,f){var g,h,k,l,n,r,m,q,H;if(3!==a.nodeType&&8!==a.nodeType&&b&&d&&(g=c._data(a))){d.handler&&(m=d,d=m.handler,f=m.selector);
d.guid||(d.guid=c.guid++);(k=g.events)||(g.events=k={});(h=g.handle)||(g.handle=h=function(a){return"undefined"==typeof c||a&&c.event.triggered===a.type?p:c.event.dispatch.apply(h.elem,arguments)},h.elem=a);b=c.trim(ib(b)).split(" ");for(g=0;g<b.length;g++)l=gb.exec(b[g])||[],n=l[1],r=(l[2]||"").split(".").sort(),H=c.event.special[n]||{},n=(f?H.delegateType:H.bindType)||n,H=c.event.special[n]||{},l=c.extend({type:n,origType:l[1],data:e,handler:d,guid:d.guid,selector:f,needsContext:f&&c.expr.match.needsContext.test(f),
namespace:r.join(".")},m),q=k[n],q||(q=k[n]=[],q.delegateCount=0,H.setup&&!1!==H.setup.call(a,e,r,h)||(a.addEventListener?a.addEventListener(n,h,!1):a.attachEvent&&a.attachEvent("on"+n,h))),H.add&&(H.add.call(a,l),l.handler.guid||(l.handler.guid=d.guid)),f?q.splice(q.delegateCount++,0,l):q.push(l),c.event.global[n]=!0;a=null}},global:{},remove:function(a,b,d,e,f){var g,h,k,l,n,r,m,p,q,s,v=c.hasData(a)&&c._data(a);if(v&&(m=v.events)){b=c.trim(ib(b||"")).split(" ");for(g=0;g<b.length;g++)if(h=gb.exec(b[g])||
[],k=l=h[1],h=h[2],k){p=c.event.special[k]||{};k=(e?p.delegateType:p.bindType)||k;q=m[k]||[];n=q.length;h=h?RegExp("(^|\\.)"+h.split(".").sort().join("\\.(?:.*\\.|)")+"(\\.|$)"):null;for(r=0;r<q.length;r++)s=q[r],!f&&l!==s.origType||d&&d.guid!==s.guid||h&&!h.test(s.namespace)||e&&!(e===s.selector||"**"===e&&s.selector)||(q.splice(r--,1),s.selector&&q.delegateCount--,!p.remove||p.remove.call(a,s));0===q.length&&n!==q.length&&((!p.teardown||!1===p.teardown.call(a,h,v.handle))&&c.removeEvent(a,k,v.handle),
delete m[k])}else for(k in m)c.event.remove(a,k+b[g],d,e,!0);c.isEmptyObject(m)&&(delete v.handle,c.removeData(a,"events",!0))}},customEvent:{getData:!0,setData:!0,changeData:!0},trigger:function(a,b,d,e){if(!d||3!==d.nodeType&&8!==d.nodeType){var f,g,h,k,l,n,r,m=a.type||a;k=[];if(!hb.test(m+c.event.triggered)&&(0<=m.indexOf("!")&&(m=m.slice(0,-1),f=!0),0<=m.indexOf(".")&&(k=m.split("."),m=k.shift(),k.sort()),d&&!c.event.customEvent[m]||c.event.global[m]))if(a="object"==typeof a?a[c.expando]?a:new c.Event(m,
a):new c.Event(m),a.type=m,a.isTrigger=!0,a.exclusive=f,a.namespace=k.join("."),a.namespace_re=a.namespace?RegExp("(^|\\.)"+k.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,k=0>m.indexOf(":")?"on"+m:"",d){if(a.result=p,a.target||(a.target=d),b=null!=b?c.makeArray(b):[],b.unshift(a),l=c.event.special[m]||{},!l.trigger||!1!==l.trigger.apply(d,b)){r=[[d,l.bindType||m]];if(!e&&!l.noBubble&&!c.isWindow(d)){g=l.delegateType||m;f=hb.test(g+m)?d:d.parentNode;for(h=d;f;f=f.parentNode)r.push([f,g]),h=f;h===(d.ownerDocument||
q)&&r.push([h.defaultView||h.parentWindow||s,g])}for(g=0;g<r.length&&!a.isPropagationStopped();g++)f=r[g][0],a.type=r[g][1],(n=(c._data(f,"events")||{})[a.type]&&c._data(f,"handle"))&&n.apply(f,b),(n=k&&f[k])&&c.acceptData(f)&&n.apply&&!1===n.apply(f,b)&&a.preventDefault();return a.type=m,!e&&!a.isDefaultPrevented()&&(!l._default||!1===l._default.apply(d.ownerDocument,b))&&("click"!==m||!c.nodeName(d,"a"))&&c.acceptData(d)&&k&&d[m]&&("focus"!==m&&"blur"!==m||0!==a.target.offsetWidth)&&!c.isWindow(d)&&
(h=d[k],h&&(d[k]=null),c.event.triggered=m,d[m](),c.event.triggered=p,h&&(d[k]=h)),a.result}}else for(g in d=c.cache,d)d[g].events&&d[g].events[m]&&c.event.trigger(a,b,d[g].handle.elem,!0)}},dispatch:function(a){a=c.event.fix(a||s.event);var b,d,e,f,g,h,k=(c._data(this,"events")||{})[a.type]||[],l=k.delegateCount,n=x.call(arguments),r=!a.exclusive&&!a.namespace,m=c.event.special[a.type]||{},q=[];n[0]=a;a.delegateTarget=this;if(!m.preDispatch||!1!==m.preDispatch.call(this,a)){if(l&&(!a.button||"click"!==
a.type))for(d=a.target;d!=this;d=d.parentNode||this)if(!0!==d.disabled||"click"!==a.type){f={};g=[];for(b=0;b<l;b++)e=k[b],h=e.selector,f[h]===p&&(f[h]=e.needsContext?0<=c(h,this).index(d):c.find(h,this,null,[d]).length),f[h]&&g.push(e);g.length&&q.push({elem:d,matches:g})}k.length>l&&q.push({elem:this,matches:k.slice(l)});for(b=0;b<q.length&&!a.isPropagationStopped();b++)for(f=q[b],a.currentTarget=f.elem,d=0;d<f.matches.length&&!a.isImmediatePropagationStopped();d++)if(e=f.matches[d],r||!a.namespace&&
...
q.removeEventListener?function(a,b,c){a.removeEventListener&&a.removeEventListener(b,c,!1)}:function(a,b,c){b="on"+b;a.detachEvent&&("undefined"==typeof a[b]&&(a[b]=null),a.detachEvent(b,c))};c.Event=function(a,b){if(this instanceof c.Event)a&&a.type?(this.originalEvent=a,this.type=a.type,this.isDefaultPrevented=a.defaultPrevented||!1===a.returnValue||a.getPreventDefault&&a.getPreventDefault()?N:R):this.type=a,b&&c.extend(this,b),this.timeStamp=a&&a.timeStamp||c.now(),this[c.expando]=!0;else return new c.Event(a,
b)};c.Event.prototype={preventDefault:function(){this.isDefaultPrevented=N;var a=this.originalEvent;a&&(a.preventDefault?a.preventDefault():a.returnValue=!1)},stopPropagation:function(){this.isPropagationStopped=N;var a=this.originalEvent;a&&(a.stopPropagation&&a.stopPropagation(),a.cancelBubble=!0)},stopImmediatePropagation:function(){this.isImmediatePropagationStopped=N;this.stopPropagation()},isDefaultPrevented:R,isPropagationStopped:R,isImmediatePropagationStopped:R};c.each({mouseenter:"mouseover",
...
(c.event.add(a,"submit._submit",function(a){a._submit_bubble=!0}),c._data(a,"_submit_attached",!0))})},postDispatch:function(a){a._submit_bubble&&(delete a._submit_bubble,this.parentNode&&!a.isTrigger&&c.event.simulate("submit",this.parentNode,a,!0))},teardown:function(){if(c.nodeName(this,"form"))return!1;c.event.remove(this,"._submit")}});c.support.changeBubbles||(c.event.special.change={setup:function(){if(ta.test(this.nodeName)){if("checkbox"===this.type||"radio"===this.type)c.event.add(this,
"propertychange._change",function(a){"checked"===a.originalEvent.propertyName&&(this._just_changed=!0)}),c.event.add(this,"click._change",function(a){this._just_changed&&!a.isTrigger&&(this._just_changed=!1);c.event.simulate("change",this,a,!0)});return!1}c.event.add(this,"beforeactivate._change",function(a){a=a.target;ta.test(a.nodeName)&&!c._data(a,"_change_attached")&&(c.event.add(a,"change._change",function(a){this.parentNode&&!a.isSimulated&&!a.isTrigger&&c.event.simulate("change",this.parentNode,
a,!0)}),c._data(a,"_change_attached",!0))})},handle:function(a){var b=a.target;if(this!==b||a.isSimulated||a.isTrigger||"radio"!==b.type&&"checkbox"!==b.type)return a.handleObj.handler.apply(this,arguments)},teardown:function(){return c.event.remove(this,"._change"),!ta.test(this.nodeName)}});c.support.focusinBubbles||c.each({focus:"focusin",blur:"focusout"},function(a,b){var d=0,e=function(a){c.event.simulate(b,a.target,c.event.fix(a),!0)};c.event.special[b]={setup:function(){0===d++&&q.addEventListener(a,
...
function(a,c){return null==c&&(c=a,a=null),0<arguments.length?this.on(b,null,a,c):this.trigger(b)};ec.test(b)&&(c.event.fixHooks[b]=c.event.keyHooks);fc.test(b)&&(c.event.fixHooks[b]=c.event.mouseHooks)});(function(a,b){function d(a,b,c,d){c=c||[];b=b||O;var e,f,g,h,k=b.nodeType;if(!a||"string"!=typeof a)return c;if(1!==k&&9!==k)return[];g=x(b);if(!g&&!d&&(e=W.exec(a)))if(h=e[1])if(9===k){f=b.getElementById(h);if(!f||!f.parentNode)return c;if(f.id===h)return c.push(f),c}else{if(b.ownerDocument&&(f=
b.ownerDocument.getElementById(h))&&t(b,f)&&f.id===h)return c.push(f),c}else{if(e[2])return D.apply(c,A.call(b.getElementsByTagName(a),0)),c;if((h=e[3])&&Y&&b.getElementsByClassName)return D.apply(c,A.call(b.getElementsByClassName(h),0)),c}return s(a.replace(F,"$1"),b,c,d,g)}function e(a){return function(b){return"input"===b.nodeName.toLowerCase()&&b.type===a}}function f(a){return function(b){var c=b.nodeName.toLowerCase();return("input"===c||"button"===c)&&b.type===a}}function g(a){return P(function(b){return b=
+b,P(function(c,d){for(var e,f=a([],c.length,b),g=f.length;g--;)c[e=f[g]]&&(c[e]=!(d[e]=c[e]))})})}function h(a,b,c){if(a===b)return c;for(a=a.nextSibling;a;){if(a===b)return-1;a=a.nextSibling}return 1}function k(a,b){var c,e,f,g,h,k,l;if(h=G[B][a])return b?0:h.slice(0);h=a;k=[];for(l=u.preFilter;h;){if(!c||(e=R.exec(h)))e&&(h=h.slice(e[0].length)),k.push(f=[]);c=!1;if(e=S.exec(h))f.push(c=new lb(e.shift())),h=h.slice(c.length),c.type=e[0].replace(F," ");for(g in u.filter)(e=N[g].exec(h))&&(!l[g]||
(e=l[g](e,O,!0)))&&(f.push(c=new lb(e.shift())),h=h.slice(c.length),c.type=g,c.matches=e);if(!c)break}return b?h.length:h?d.error(a):G(a,k).slice(0)}function l(a,b,c){var d=b.dir,e=c&&"parentNode"===b.dir,f=gc++;return b.first?function(b,c,f){for(;b=b[d];)if(e||1===b.nodeType)return a(b,c,f)}:function(b,c,g){if(!g)for(var h,k=ea+" "+f+" ",jb=k+C;b=b[d];){if(e||1===b.nodeType){if((h=b[B])===jb)return b.sizset;if("string"==typeof h&&0===h.indexOf(k)){if(b.sizset)return b}else{b[B]=jb;if(a(b,c,g))return b.sizset=
!0,b;b.sizset=!1}}}else for(;b=b[d];)if((e||1===b.nodeType)&&a(b,c,g))return b}}function n(a){return 1<a.length?function(b,c,d){for(var e=a.length;e--;)if(!a[e](b,c,d))return!1;return!0}:a[0]}function r(a,b,c,d,e){for(var f,g=[],h=0,k=a.length,l=null!=b;h<k;h++)if(f=a[h])if(!c||c(f,d,e))g.push(f),l&&b.push(h);return g}function m(a,b,c,e,f,g){return e&&!e[B]&&(e=m(e)),f&&!f[B]&&(f=m(f,g)),P(function(g,h,k,l){if(!g||!f){var m,n,p=[],q=[],kb=h.length;if(!(n=g)){n=b||"*";var s=k.nodeType?[k]:k,t=[];m=
0;for(var H=s.length;m<H;m++)d(n,s[m],t,g);n=t}s=!a||!g&&b?n:r(n,p,a,k,l);t=c?f||(g?a:kb||e)?[]:h:s;c&&c(s,t,k,l);if(e)for(n=r(t,q),e(n,[],k,l),k=n.length;k--;)if(m=n[k])t[q[k]]=!(s[q[k]]=m);if(g)for(k=a&&t.length;k--;){if(m=t[k])g[p[k]]=!(h[p[k]]=m)}else t=r(t===h?t.splice(kb,t.length):t),f?f(null,h,t,l):D.apply(h,t)}})}function p(a){var b,c,d,e=a.length,f=u.relative[a[0].type];c=f||u.relative[" "];for(var g=f?1:0,h=l(function(a){return a===b},c,!0),k=l(function(a){return-1<mb.call(b,a)},c,!0),r=
[function(a,c,d){return!f&&(d||c!==ka)||((b=c).nodeType?h(a,c,d):k(a,c,d))}];g<e;g++)if(c=u.relative[a[g].type])r=[l(n(r),c)];else{c=u.filter[a[g].type].apply(null,a[g].matches);if(c[B]){for(d=++g;d<e&&!u.relative[a[d].type];d++);return m(1<g&&n(r),1<g&&a.slice(0,g-1).join("").replace(F,"$1"),c,g<d&&p(a.slice(g,d)),d<e&&p(a=a.slice(d)),d<e&&a.join(""))}r.push(c)}return n(r)}function q(a,b){var c=0<b.length,e=0<a.length,f=function(g,h,k,l,m){var n,p,q=[],s=0,t="0",H=g&&[],Q=null!=m,w=ka,v=g||e&&u.find.TAG("*",
m&&h.parentNode||h),B=ea+=null==w?1:Math.E;for(Q&&(ka=h!==O&&h,C=f.el);null!=(m=v[t]);t++){if(e&&m){for(n=0;p=a[n];n++)if(p(m,h,k)){l.push(m);break}Q&&(ea=B,C=++f.el)}c&&((m=!p&&m)&&s--,g&&H.push(m))}s+=t;if(c&&t!==s){for(n=0;p=b[n];n++)p(H,q,h,k);if(g){if(0<s)for(;t--;)H[t]||q[t]||(q[t]=I.call(l));q=r(q)}D.apply(l,q);Q&&!g&&0<q.length&&1<s+b.length&&d.uniqueSort(l)}return Q&&(ea=B,ka=w),H};return f.el=0,c?P(f):f}function s(a,b,c,d,e){var f,g,h,l,m=k(a);if(!d&&1===m.length){g=m[0]=m[0].slice(0);if(2<
g.length&&"ID"===(h=g[0]).type&&9===b.nodeType&&!e&&u.relative[g[1].type]){b=u.find.ID(h.matches[0].replace($,""),b,e)[0];if(!b)return c;a=a.slice(g.shift().length)}for(f=N.POS.test(a)?-1:g.length-1;0<=f;f--){h=g[f];if(u.relative[l=h.type])break;if(l=u.find[l])if(d=l(h.matches[0].replace($,""),K.test(g[0].type)&&b.parentNode||b,e)){g.splice(f,1);a=d.length&&g.join("");if(!a)return D.apply(c,A.call(d,0)),c;break}}}return y(a,m)(d,b,e,c,K.test(a)),c}function v(){}var C,z,u,J,x,t,y,L,Q,ka,nb=!0,B=("sizcache"+
Math.random()).replace(".",""),lb=String,O=a.document,w=O.documentElement,ea=0,gc=0,I=[].pop,D=[].push,A=[].slice,mb=[].indexOf||function(a){for(var b=0,c=this.length;b<c;b++)if(this[b]===a)return b;return-1},P=function(a,b){return a[B]=null==b||b,a},U=function(){var a={},b=[];return P(function(c,d){return b.push(c)>u.cacheLength&&delete a[b.shift()],a[c]=d},a)},M=U(),G=U(),E=U(),U="\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[-\\w]|[^\\x00-\\xa0])+)[\\x20\\t\\r\\n\\f]*(?:([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|("+
"(?:\\\\.|[-\\w]|[^\\x00-\\xa0])+".replace("w","w#")+")|)|)[\\x20\\t\\r\\n\\f]*\\]",ua=":((?:\\\\.|[-\\w]|[^\\x00-\\xa0])+)(?:\\((?:(['\"])((?:\\\\.|[^\\\\])*?)\\2|([^()[\\]]*|(?:(?:"+U+")|[^:]|\\\\.)*|.*))\\)|)",F=RegExp("^[\\x20\\t\\r\\n\\f]+|((?:^|[^\\\\])(?:\\\\.)*)[\\x20\\t\\r\\n\\f]+$","g"),R=/^[\x20\t\r\n\f]*,[\x20\t\r\n\f]*/,S=/^[\x20\t\r\n\f]*([\x20\t\r\n\f>+~])[\x20\t\r\n\f]*/,T=RegExp(ua),W=/^(?:#([\w\-]+)|(\w+)|\.([\w\-]+))$/,K=/[\x20\t\r\n\f]*[+~]/,X=/h\d/i,Z=/input|select|textarea|button/i,
$=/\\(?!\\)/g,N={ID:/^#((?:\\.|[-\w]|[^\x00-\xa0])+)/,CLASS:/^\.((?:\\.|[-\w]|[^\x00-\xa0])+)/,NAME:/^\[name=['"]?((?:\\.|[-\w]|[^\x00-\xa0])+)['"]?\]/,TAG:RegExp("^("+"(?:\\\\.|[-\\w]|[^\\x00-\\xa0])+".replace("w","w*")+")"),ATTR:RegExp("^"+U),PSEUDO:RegExp("^"+ua),POS:/:(even|odd|eq|gt|lt|nth|first|last)(?:\([\x20\t\r\n\f]*((?:-\d)?\d*)[\x20\t\r\n\f]*\)|)(?=[^-]|$)/i,CHILD:RegExp("^:(only|nth|first|last)-child(?:\\([\\x20\\t\\r\\n\\f]*(even|odd|(([+-]|)(\\d*)n|)[\\x20\\t\\r\\n\\f]*(?:([+-]|)[\\x20\\t\\r\\n\\f]*(\\d+)|))[\\x20\\t\\r\\n\\f]*\\)|)",
"i"),needsContext:RegExp("^[\\x20\\t\\r\\n\\f]*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\([\\x20\\t\\r\\n\\f]*((?:-\\d)?\\d*)[\\x20\\t\\r\\n\\f]*\\)|)(?=[^-]|$)","i")},V=function(a){var b=O.createElement("div");try{return a(b)}catch(c){return!1}finally{}},U=V(function(a){return a.appendChild(O.createComment("")),!a.getElementsByTagName("*").length}),aa=V(function(a){return a.innerHTML="<a href='#'></a>",a.firstChild&&"undefined"!==typeof a.firstChild.getAttribute&&"#"===a.firstChild.getAttribute("href")}),
ba=V(function(a){a.innerHTML="<select></select>";a=typeof a.lastChild.getAttribute("multiple");return"boolean"!==a&&"string"!==a}),Y=V(function(a){return a.innerHTML="<div class='hidden e'></div><div class='hidden'></div>",a.getElementsByClassName&&a.getElementsByClassName("e").length?(a.lastChild.className="e",2===a.getElementsByClassName("e").length):!1}),ca=V(function(a){a.id=B+0;a.innerHTML="<a name='"+B+"'></a><div name='"+B+"'></div>";w.insertBefore(a,w.firstChild);var b=O.getElementsByName&&
O.getElementsByName(B).length===2+O.getElementsByName(B+0).length;return z=!O.getElementById(B),w.removeChild(a),b});try{A.call(w.childNodes,0)[0].nodeType}catch(da){A=function(a){for(var b,c=[];b=this[a];a++)c.push(b);return c}}d.matches=function(a,b){return d(a,null,null,b)};d.matchesSelector=function(a,b){return 0<d(b,null,null,[a]).length};J=d.getText=function(a){var b,c="",d=0;if(b=a.nodeType)if(1===b||9===b||11===b){if("string"==typeof a.textContent)return a.textContent;for(a=a.firstChild;a;a=
a.nextSibling)c+=J(a)}else{if(3===b||4===b)return a.nodeValue}else for(;b=a[d];d++)c+=J(b);return c};x=d.isXML=function(a){return(a=a&&(a.ownerDocument||a).documentElement)?"HTML"!==a.nodeName:!1};t=d.contains=w.contains?function(a,b){var c=9===a.nodeType?a.documentElement:a,d=b&&b.parentNode;return a===d||!!(d&&1===d.nodeType&&c.contains&&c.contains(d))}:w.compareDocumentPosition?function(a,b){return b&&!!(a.compareDocumentPosition(b)&16)}:function(a,b){for(;b=b.parentNode;)if(b===a)return!0;return!1};
d.attr=function(a,b){var c,d=x(a);return d||(b=b.toLowerCase()),(c=u.attrHandle[b])?c(a):d||ba?a.getAttribute(b):(c=a.getAttributeNode(b),c?"boolean"==typeof a[b]?a[b]?b:null:c.specified?c.value:null:null)};u=d.selectors={cacheLength:50,createPseudo:P,match:N,attrHandle:aa?{}:{href:function(a){return a.getAttribute("href",2)},type:function(a){return a.getAttribute("type")}},find:{ID:z?function(a,b,c){if("undefined"!==typeof b.getElementById&&!c)return(a=b.getElementById(a))&&a.parentNode?[a]:[]}:
...
a[2]||"odd"===a[2])),a[4]=+(a[6]+a[7]||"odd"===a[2])):a[2]&&d.error(a[0]),a},PSEUDO:function(a){var b,c;if(N.CHILD.test(a[0]))return null;if(a[3])a[2]=a[3];else if(b=a[4])T.test(b)&&(c=k(b,!0))&&(c=b.indexOf(")",b.length-c)-b.length)&&(b=b.slice(0,c),a[0]=a[0].slice(0,c)),a[2]=b;return a.slice(0,3)}},filter:{ID:z?function(a){return a=a.replace($,""),function(b){return b.getAttribute("id")===a}}:function(a){return a=a.replace($,""),function(b){return(b="undefined"!==typeof b.getAttributeNode&&b.getAttributeNode("id"))&&
b.value===a}},TAG:function(a){return"*"===a?function(){return!0}:(a=a.replace($,"").toLowerCase(),function(b){return b.nodeName&&b.nodeName.toLowerCase()===a})},CLASS:function(a){var b=M[B][a];return b||(b=M(a,RegExp("(^|[\\x20\\t\\r\\n\\f])"+a+"([\\x20\\t\\r\\n\\f]|$)"))),function(a){return b.test(a.className||"undefined"!==typeof a.getAttribute&&a.getAttribute("class")||"")}},ATTR:function(a,b,c){return function(e,f){var g=d.attr(e,a);return null==g?"!="===b:b?(g+="","="===b?g===c:"!="===b?g!==
c:"^="===b?c&&0===g.indexOf(c):"*="===b?c&&-1<g.indexOf(c):"$="===b?c&&g.substr(g.length-c.length)===c:"~="===b?-1<(" "+g+" ").indexOf(c):"|="===b?g===c||g.substr(0,c.length+1)===c+"-":!1):!0}},CHILD:function(a,b,c,d){return"nth"===a?function(a){var b,e;b=a.parentNode;if(1===c&&0===d)return!0;if(b)for(e=0,b=b.firstChild;b&&(1!==b.nodeType||(e++,a!==b));b=b.nextSibling);return e-=d,e===c||0===e%c&&0<=e/c}:function(b){var c=b;switch(a){case "only":case "first":for(;c=c.previousSibling;)if(1===c.nodeType)return!1;
if("first"===a)return!0;c=b;case "last":for(;c=c.nextSibling;)if(1===c.nodeType)return!1;return!0}}},PSEUDO:function(a,b){var c,e=u.pseudos[a]||u.setFilters[a.toLowerCase()]||d.error("unsupported pseudo: "+a);return e[B]?e(b):1<e.length?(c=[a,a,"",b],u.setFilters.hasOwnProperty(a.toLowerCase())?P(function(a,c){for(var d,f=e(a,b),g=f.length;g--;)d=mb.call(a,f[g]),a[d]=!(c[d]=f[g])}):function(a){return e(a,0,c)}):e}},pseudos:{not:P(function(a){var b=[],c=[],d=y(a.replace(F,"$1"));return d[B]?P(function(a,
b,c,e){e=d(a,null,e,[]);for(var f=a.length;f--;)if(c=e[f])a[f]=!(b[f]=c)}):function(a,e,f){return b[0]=a,d(b,null,f,c),!c.pop()}}),has:P(function(a){return function(b){return 0<d(a,b).length}}),contains:P(function(a){return function(b){return-1<(b.textContent||b.innerText||J(b)).indexOf(a)}}),enabled:function(a){return!1===a.disabled},disabled:function(a){return!0===a.disabled},checked:function(a){var b=a.nodeName.toLowerCase();return"input"===b&&!!a.checked||"option"===b&&!!a.selected},selected:function(a){return a.parentNode&&
a.parentNode.selectedIndex,!0===a.selected},parent:function(a){return!u.pseudos.empty(a)},empty:function(a){var b;for(a=a.firstChild;a;){if("@"<a.nodeName||3===(b=a.nodeType)||4===b)return!1;a=a.nextSibling}return!0},header:function(a){return X.test(a.nodeName)},text:function(a){var b,c;return"input"===a.nodeName.toLowerCase()&&"text"===(b=a.type)&&(null==(c=a.getAttribute("type"))||c.toLowerCase()===b)},radio:e("radio"),checkbox:e("checkbox"),file:e("file"),password:e("password"),image:e("image"),
submit:f("submit"),reset:f("reset"),button:function(a){var b=a.nodeName.toLowerCase();return"input"===b&&"button"===a.type||"button"===b},input:function(a){return Z.test(a.nodeName)},focus:function(a){var b=a.ownerDocument;return a===b.activeElement&&(!b.hasFocus||b.hasFocus())&&(!!a.type||!!a.href)},active:function(a){return a===a.ownerDocument.activeElement},first:g(function(a,b,c){return[0]}),last:g(function(a,b,c){return[b-1]}),eq:g(function(a,b,c){return[0>c?c+b:c]}),even:g(function(a,b,c){for(c=
0;c<b;c+=2)a.push(c);return a}),odd:g(function(a,b,c){for(c=1;c<b;c+=2)a.push(c);return a}),lt:g(function(a,b,c){for(b=0>c?c+b:c;0<=--b;)a.push(b);return a}),gt:g(function(a,b,c){for(c=0>c?c+b:c;++c<b;)a.push(c);return a})}};L=w.compareDocumentPosition?function(a,b){return a===b?(Q=!0,0):(a.compareDocumentPosition&&b.compareDocumentPosition?a.compareDocumentPosition(b)&4:a.compareDocumentPosition)?-1:1}:function(a,b){if(a===b)return Q=!0,0;if(a.sourceIndex&&b.sourceIndex)return a.sourceIndex-b.sourceIndex;
var c,d,e=[],f=[];c=a.parentNode;d=b.parentNode;var g=c;if(c===d)return h(a,b);if(!c)return-1;if(!d)return 1;for(;g;)e.unshift(g),g=g.parentNode;for(g=d;g;)f.unshift(g),g=g.parentNode;c=e.length;d=f.length;for(g=0;g<c&&g<d;g++)if(e[g]!==f[g])return h(e[g],f[g]);return g===c?h(a,f[g],-1):h(e[g],b,1)};[0,0].sort(L);nb=!Q;d.uniqueSort=function(a){var b,c=1;Q=nb;a.sort(L);if(Q)for(;b=a[c];c++)b===a[c-1]&&a.splice(c--,1);return a};d.error=function(a){throw Error("Syntax error, unrecognized expression: "+
a);};y=d.compile=function(a,b){var c,d=[],e=[],f=E[B][a];if(!f){b||(b=k(a));for(c=b.length;c--;)f=p(b[c]),f[B]?d.push(f):e.push(f);f=E(a,q(e,d))}return f};O.querySelectorAll&&function(){var a,b=s,c=/'|\\/g,e=/\=[\x20\t\r\n\f]*([^'"\]]*)[\x20\t\r\n\f]*\]/g,f=[":focus"],g=[":active",":focus"],h=w.matchesSelector||w.mozMatchesSelector||w.webkitMatchesSelector||w.oMatchesSelector||w.msMatchesSelector;V(function(a){a.innerHTML="<select><option selected=''></option></select>";a.querySelectorAll("[selected]").length||
f.push("\\[[\\x20\\t\\r\\n\\f]*(?:checked|disabled|ismap|multiple|readonly|selected|value)");a.querySelectorAll(":checked").length||f.push(":checked")});V(function(a){a.innerHTML="<p test=''></p>";a.querySelectorAll("[test^='']").length&&f.push("[*^$]=[\\x20\\t\\r\\n\\f]*(?:\"\"|'')");a.innerHTML="<input type='hidden'/>";a.querySelectorAll(":enabled").length||f.push(":enabled",":disabled")});f=RegExp(f.join("|"));s=function(a,d,e,g,h){if(!(g||h||f&&f.test(a))){var l,m,n=!0,r=B;m=d;l=9===d.nodeType&&
a;if(1===d.nodeType&&"object"!==d.nodeName.toLowerCase()){l=k(a);(n=d.getAttribute("id"))?r=n.replace(c,"\\$&"):d.setAttribute("id",r);r="[id='"+r+"'] ";for(m=l.length;m--;)l[m]=r+l[m].join("");m=K.test(a)&&d.parentNode||d;l=l.join(",")}if(l)try{return D.apply(e,A.call(m.querySelectorAll(l),0)),e}catch(p){}finally{n||d.removeAttribute("id")}}return b(a,d,e,g,h)};h&&(V(function(b){a=h.call(b,"div");try{h.call(b,"[test!='']:sizzle"),g.push("!=",ua)}catch(c){}}),g=RegExp(g.join("|")),d.matchesSelector=
function(b,c){c=c.replace(e,"='$1']");if(!(x(b)||g.test(c)||f&&f.test(c)))try{var k=h.call(b,c);if(k||a||b.document&&11!==b.document.nodeType)return k}catch(l){}return 0<d(c,null,null,[b]).length})}();u.pseudos.nth=u.pseudos.eq;u.filters=v.prototype=u.pseudos;u.setFilters=new v;d.attr=c.attr;c.find=d;c.expr=d.selectors;c.expr[":"]=c.expr.pseudos;c.unique=d.uniqueSort;c.text=d.getText;c.isXMLDoc=d.isXML;c.contains=d.contains})(s);var hc=/Until$/,ic=/^(?:parents|prev(?:Until|All))/,Gb=/^.[^:#\[\.,]*$/,
ob=c.expr.match.needsContext,jc={children:!0,contents:!0,next:!0,prev:!0};c.fn.extend({find:function(a){var b,d,e,f,g,h,k=this;if("string"!=typeof a)return c(a).filter(function(){b=0;for(d=k.length;b<d;b++)if(c.contains(k[b],this))return!0});h=this.pushStack("","find",a);b=0;for(d=this.length;b<d;b++)if(e=h.length,c.find(a,this[b],h),0<b)for(f=e;f<h.length;f++)for(g=0;g<e;g++)if(h[g]===h[f]){h.splice(f--,1);break}return h},has:function(a){var b,d=c(a,this),e=d.length;return this.filter(function(){for(b=
...
-1<h.index(d):c.find.matchesSelector(d,a)){g.push(d);break}d=d.parentNode}return g=1<g.length?c.unique(g):g,this.pushStack(g,"closest",a)},index:function(a){return a?"string"==typeof a?c.inArray(this[0],c(a)):c.inArray(a.jquery?a[0]:a,this):this[0]&&this[0].parentNode?this.prevAll().length:-1},add:function(a,b){var d="string"==typeof a?c(a,b):c.makeArray(a&&a.nodeType?[a]:a),e=c.merge(this.get(),d);return this.pushStack(X(d[0])||X(e[0])?e:c.unique(e))},addBack:function(a){return this.add(null==a?
this.prevObject:this.prevObject.filter(a))}});c.fn.andSelf=c.fn.addBack;c.each({parent:function(a){return(a=a.parentNode)&&11!==a.nodeType?a:null},parents:function(a){return c.dir(a,"parentNode")},parentsUntil:function(a,b,d){return c.dir(a,"parentNode",d)},next:function(a){return Ca(a,"nextSibling")},prev:function(a){return Ca(a,"previousSibling")},nextAll:function(a){return c.dir(a,"nextSibling")},prevAll:function(a){return c.dir(a,"previousSibling")},nextUntil:function(a,b,d){return c.dir(a,"nextSibling",
...
(f=f.reverse()),this.pushStack(f,a,x.call(arguments).join(","))}});c.extend({filter:function(a,b,d){return d&&(a=":not("+a+")"),1===b.length?c.find.matchesSelector(b[0],a)?[b[0]]:[]:c.find.matches(a,b)},dir:function(a,b,d){var e=[];for(a=a[b];a&&9!==a.nodeType&&(d===p||1!==a.nodeType||!c(a).is(d));)1===a.nodeType&&e.push(a),a=a[b];return e},sibling:function(a,b){for(var c=[];a;a=a.nextSibling)1===a.nodeType&&a!==b&&c.push(a);return c}});var Fa="abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
kc=/ jQuery\d+="(?:null|\d+)"/g,va=/^\s+/,pb=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,qb=/<([\w:]+)/,lc=/<tbody/i,mc=/<|&#?\w+;/,nc=/<(?:script|style|link)/i,oc=/<(?:script|object|embed|option|style)/i,wa=RegExp("<(?:"+Fa+")[\\s/>]","i"),Ia=/^(?:checkbox|radio)$/,rb=/checked\s*(?:[^=]|=\s*.checked.)/i,pc=/\/(java|ecma)script/i,qc=/^\s*<!(?:\[CDATA\[|\-\-)|[\]\-]{2}>\s*$/g,z={option:[1,"<select multiple='multiple'>","</select>"],legend:[1,"<fieldset>","</fieldset>"],
thead:[1,"<table>","</table>"],tr:[2,"<table><tbody>","</tbody></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],area:[1,"<map>","</map>"],_default:[0,"",""]},sb=Ea(q),xa=sb.appendChild(q.createElement("div"));z.optgroup=z.option;z.tbody=z.tfoot=z.colgroup=z.caption=z.thead;z.th=z.td;c.support.htmlSerialize||(z._default=[1,"X<div>","</div>"]);c.fn.extend({text:function(a){return c.access(this,function(a){return a===p?c.text(this):
...
a,b)})},html:function(a){return c.access(this,function(a){var d=this[0]||{},e=0,f=this.length;if(a===p)return 1===d.nodeType?d.innerHTML.replace(kc,""):p;if("string"==typeof a&&!(nc.test(a)||!c.support.htmlSerialize&&wa.test(a)||!c.support.leadingWhitespace&&va.test(a)||z[(qb.exec(a)||["",""])[1].toLowerCase()])){a=a.replace(pb,"<$1></$2>");try{for(;e<f;e++)d=this[e]||{},1===d.nodeType&&(c.cleanData(d.getElementsByTagName("*")),d.innerHTML=a);d=0}catch(g){}}d&&this.empty().append(a)},null,a,arguments.length)},
...
(Ga(a,h),d))for(e=aa(a),f=aa(h),g=0;e[g];++g)Ga(e[g],f[g]);return h},clean:function(a,b,d,e){var f,g,h,k,l,n,r,m=b===q&&sb,p=[];b&&"undefined"!=typeof b.createDocumentFragment||(b=q);for(f=0;null!=(h=a[f]);f++)if("number"==typeof h&&(h+=""),h){if("string"==typeof h)if(mc.test(h)){m=m||Ea(b);n=b.createElement("div");m.appendChild(n);h=h.replace(pb,"<$1></$2>");g=(qb.exec(h)||["",""])[1].toLowerCase();k=z[g]||z._default;l=k[0];for(n.innerHTML=k[1]+h+k[2];l--;)n=n.lastChild;if(!c.support.tbody)for(l=
...
f,g,b)};a.fn.init.prototype=a.fn;var b=a(q);return a}})();var v,S,T,ya=/alpha\([^)]*\)/i,rc=/opacity=([^)]*)/,sc=/^(top|right|bottom|left)$/,tc=/^(none|table(?!-c[ea]).+)/,tb=/^margin/,Hb=RegExp("^("+ia+")(.*)$","i"),Y=RegExp("^("+ia+")(?!px)[a-z%]+$","i"),uc=RegExp("^([-+])=("+ia+")","i"),oa={},vc={position:"absolute",visibility:"hidden",display:"block"},ub={letterSpacing:0,fontWeight:400},G=["Top","Right","Bottom","Left"],La=["Webkit","O","Moz","ms"],wc=c.fn.toggle;c.fn.extend({css:function(a,b){return c.access(this,
function(a,b,f){return f!==p?c.style(a,b,f):c.css(a,b)},a,b,1<arguments.length)},show:function(){return Ma(this,!0)},hide:function(){return Ma(this)},toggle:function(a,b){var d="boolean"==typeof a;return c.isFunction(a)&&c.isFunction(b)?wc.apply(this,arguments):this.each(function(){(d?a:ba(this))?c(this).show():c(this).hide()})}});c.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=v(a,"opacity");return""===c?"1":c}}}},cssNumber:{fillOpacity:!0,fontWeight:!0,lineHeight:!0,opacity:!0,orphans:!0,
widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":c.support.cssFloat?"cssFloat":"styleFloat"},style:function(a,b,d,e){if(a&&3!==a.nodeType&&8!==a.nodeType&&a.style){var f,g,h,k=c.camelCase(b),l=a.style;b=c.cssProps[k]||(c.cssProps[k]=Ka(l,k));h=c.cssHooks[b]||c.cssHooks[k];if(d===p)return h&&"get"in h&&(f=h.get(a,!1,e))!==p?f:l[b];g=typeof d;"string"===g&&(f=uc.exec(d))&&(d=(f[1]+1)*f[2]+parseFloat(c.css(a,b)),g="number");if(!(null==d||"number"===g&&isNaN(d)||("number"===g&&!c.cssNumber[k]&&(d+="px"),
h&&"set"in h&&(d=h.set(a,d,e))===p)))try{l[b]=d}catch(n){}}},css:function(a,b,d,e){var f,g,h,k=c.camelCase(b);return b=c.cssProps[k]||(c.cssProps[k]=Ka(a.style,k)),h=c.cssHooks[b]||c.cssHooks[k],h&&"get"in h&&(f=h.get(a,!0,e)),f===p&&(f=v(a,b)),"normal"===f&&b in ub&&(f=ub[b]),d||e!==p?(g=parseFloat(f),d||c.isNumeric(g)?g||0:f):f},swap:function(a,b,c){var e,f={};for(e in b)f[e]=a.style[e],a.style[e]=b[e];c=c.call(a);for(e in b)a.style[e]=f[e];return c}});s.getComputedStyle?v=function(a,b){var d,e,
f,g,h=s.getComputedStyle(a,null),k=a.style;return h&&(d=h[b],""===d&&!c.contains(a.ownerDocument,a)&&(d=c.style(a,b)),Y.test(d)&&tb.test(b)&&(e=k.width,f=k.minWidth,g=k.maxWidth,k.minWidth=k.maxWidth=k.width=d,d=h.width,k.width=e,k.minWidth=f,k.maxWidth=g)),d}:q.documentElement.currentStyle&&(v=function(a,b){var c,e,f=a.currentStyle&&a.currentStyle[b],g=a.style;return null==f&&g&&g[b]&&(f=g[b]),Y.test(f)&&!sc.test(b)&&(c=g.left,e=a.runtimeStyle&&a.runtimeStyle.left,e&&(a.runtimeStyle.left=a.currentStyle.left),
g.left="fontSize"===b?"1em":f,f=g.pixelLeft+"px",g.left=c,e&&(a.runtimeStyle.left=e)),""===f?"auto":f});c.each(["height","width"],function(a,b){c.cssHooks[b]={get:function(a,e,f){if(e)return 0===a.offsetWidth&&tc.test(v(a,"display"))?c.swap(a,vc,function(){return Qa(a,b,f)}):Qa(a,b,f)},set:function(a,e,f){return Oa(a,e,f?Pa(a,b,f,c.support.boxSizing&&"border-box"===c.css(a,"boxSizing")):0)}}});c.support.opacity||(c.cssHooks.opacity={get:function(a,b){return rc.test((b&&a.currentStyle?a.currentStyle.filter:
...
c.ajaxSettings.traditional);if(c.isArray(a)||a.jquery&&!c.isPlainObject(a))c.each(a,function(){f(this.name,this.value)});else for(d in a)pa(d,a[d],b,f);return e.join("&").replace(xc,"+")};var W,F,Ac=/#.*$/,Bc=/^(.*?):[ \t]*([^\r\n]*)\r?$/mg,Cc=/^(?:GET|HEAD)$/,Dc=/^\/\//,wb=/\?/,Ec=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,Fc=/([?&])_=[^&]*/,xb=/^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/,yb=c.fn.load,qa={},zb={},Ab=["*/"]+["*"];try{F=Lb.href}catch(Mc){F=q.createElement("a"),F.href=
"",F=F.href}W=xb.exec(F.toLowerCase())||[];c.fn.load=function(a,b,d){if("string"!=typeof a&&yb)return yb.apply(this,arguments);if(!this.length)return this;var e,f,g,h=this,k=a.indexOf(" ");return 0<=k&&(e=a.slice(k,a.length),a=a.slice(0,k)),c.isFunction(b)?(d=b,b=p):b&&"object"==typeof b&&(f="POST"),c.ajax({url:a,type:f,dataType:"html",data:b,complete:function(a,b){d&&h.each(d,g||[a.responseText,b,a])}}).done(function(a){g=arguments;h.html(e?c("<div>").append(a.replace(Ec,"")).find(e):a)}),this};
c.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".split(" "),function(a,b){c.fn[b]=function(a){return this.on(b,a)}});c.each(["get","post"],function(a,b){c[b]=function(a,e,f,g){return c.isFunction(e)&&(g=g||f,f=e,e=p),c.ajax({type:b,url:a,data:e,success:f,dataType:g})}});c.extend({getScript:function(a,b){return c.get(a,p,b,"script")},getJSON:function(a,b,d){return c.get(a,b,d,"json")},ajaxSetup:function(a,b){return b?Sa(a,c.ajaxSettings):(b=a,a=c.ajaxSettings),Sa(a,b),a},ajaxSettings:{url:F,
...
flatOptions:{context:!0,url:!0}},ajaxPrefilter:Ra(qa),ajaxTransport:Ra(zb),ajax:function(a,b){function d(a,b,d,g){var l,r,w,u,x,I=b;if(2!==J){J=2;k&&clearTimeout(k);h=p;f=g||"";t.readyState=0<a?4:0;if(d){u=m;g=t;var D,A,y,F,G=u.contents,M=u.dataTypes,L=u.responseFields;for(A in L)A in d&&(g[L[A]]=d[A]);for(;"*"===M[0];)M.shift(),D===p&&(D=u.mimeType||g.getResponseHeader("content-type"));if(D)for(A in G)if(G[A]&&G[A].test(D)){M.unshift(A);break}if(M[0]in d)y=M[0];else{for(A in d){if(!M[0]||u.converters[A+
" "+M[0]]){y=A;break}F||(F=A)}y=y||F}d=y?(y!==M[0]&&M.unshift(y),d[y]):void 0;u=d}if(200<=a&&300>a||304===a)if(m.ifModified&&(x=t.getResponseHeader("Last-Modified"),x&&(c.lastModified[e]=x),x=t.getResponseHeader("Etag"),x&&(c.etag[e]=x)),304===a)I="notmodified",l=!0;else{var E;a:{l=m;r=u;var K,I=l.dataTypes.slice();d=I[0];D={};A=0;l.dataFilter&&(r=l.dataFilter(r,l.dataType));if(I[1])for(E in l.converters)D[E.toLowerCase()]=l.converters[E];for(;w=I[++A];)if("*"!==w){if("*"!==d&&d!==w){E=D[d+" "+w]||
D["* "+w];if(!E)for(K in D)if(x=K.split(" "),x[1]===w&&(E=D[d+" "+x[0]]||D["* "+x[0]])){!0===E?E=D[K]:!0!==D[K]&&(w=x[0],I.splice(A--,0,w));break}if(!0!==E)if(E&&l["throws"])r=E(r);else try{r=E(r)}catch(N){E={state:"parsererror",error:E?N:"No conversion from "+d+" to "+w};break a}}d=w}E={state:"success",data:r}}l=E;I=l.state;r=l.data;w=l.error;l=!w}else if(w=I,!I||a)I="error",0>a&&(a=0);t.status=a;t.statusText=(b||I)+"";l?v.resolveWith(q,[r,I,t]):v.rejectWith(q,[t,I,w]);t.statusCode(z);z=p;n&&s.trigger("ajax"+
(l?"Success":"Error"),[t,m,l?r:w]);C.fireWith(q,[t,I]);n&&(s.trigger("ajaxComplete",[t,m]),--c.active||c.event.trigger("ajaxStop"))}}"object"==typeof a&&(b=a,a=p);b=b||{};var e,f,g,h,k,l,n,r,m=c.ajaxSetup({},b),q=m.context||m,s=q!==m&&(q.nodeType||q instanceof c)?c(q):c.event,v=c.Deferred(),C=c.Callbacks("once memory"),z=m.statusCode||{},x={},u={},J=0,y="canceled",t={readyState:0,setRequestHeader:function(a,b){if(!J){var c=a.toLowerCase();a=u[c]=u[c]||a;x[a]=b}return this},getAllResponseHeaders:function(){return 2===
J?f:null},getResponseHeader:function(a){var b;if(2===J){if(!g)for(g={};b=Bc.exec(f);)g[b[1].toLowerCase()]=b[2];b=g[a.toLowerCase()]}return b===p?null:b},overrideMimeType:function(a){return J||(m.mimeType=a),this},abort:function(a){return a=a||y,h&&h.abort(a),d(0,a),this}};v.promise(t);t.success=t.done;t.error=t.fail;t.complete=C.add;t.statusCode=function(a){if(a){var b;if(2>J)for(b in a)z[b]=[z[b],a[b]];else b=a[t.status],t.always(b)}return this};m.url=((a||m.url)+"").replace(Ac,"").replace(Dc,W[1]+
"//");m.dataTypes=c.trim(m.dataType||"*").toLowerCase().split(L);null==m.crossDomain&&(l=xb.exec(m.url.toLowerCase())||!1,m.crossDomain=l&&l.join(":")+(l[3]?"":"http:"===l[1]?80:443)!==W.join(":")+(W[3]?"":"http:"===W[1]?80:443));m.data&&m.processData&&"string"!=typeof m.data&&(m.data=c.param(m.data,m.traditional));ca(qa,m,b,t);if(2===J)return t;n=m.global;m.type=m.type.toUpperCase();m.hasContent=!Cc.test(m.type);n&&0===c.active++&&c.event.trigger("ajaxStart");if(!m.hasContent&&(m.data&&(m.url+=(wb.test(m.url)?
"&":"?")+m.data,delete m.data),e=m.url,!1===m.cache)){l=c.now();var F=m.url.replace(Fc,"$1_="+l);m.url=F+(F===m.url?(wb.test(m.url)?"&":"?")+"_="+l:"")}(m.data&&m.hasContent&&!1!==m.contentType||b.contentType)&&t.setRequestHeader("Content-Type",m.contentType);m.ifModified&&(e=e||m.url,c.lastModified[e]&&t.setRequestHeader("If-Modified-Since",c.lastModified[e]),c.etag[e]&&t.setRequestHeader("If-None-Match",c.etag[e]));t.setRequestHeader("Accept",m.dataTypes[0]&&m.accepts[m.dataTypes[0]]?m.accepts[m.dataTypes[0]]+
("*"!==m.dataTypes[0]?", "+Ab+"; q=0.01":""):m.accepts["*"]);for(r in m.headers)t.setRequestHeader(r,m.headers[r]);if(!m.beforeSend||!1!==m.beforeSend.call(q,t,m)&&2!==J){y="abort";for(r in{success:1,error:1,complete:1})t[r](m[r]);if(h=ca(zb,m,b,t)){t.readyState=1;n&&s.trigger("ajaxSend",[t,m]);m.async&&0<m.timeout&&(k=setTimeout(function(){t.abort("timeout")},m.timeout));try{J=1,h.send(x,d)}catch(G){if(2>J)d(-1,G);else throw G;}}else d(-1,"No Transport");return t}return t.abort()},active:0,lastModified:{},
etag:{}});var Bb=[],Gc=/\?/,la=/(=)\?(?=&|$)|\?\?/,Hc=c.now();c.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var a=Bb.pop()||c.expando+"_"+Hc++;return this[a]=!0,a}});c.ajaxPrefilter("json jsonp",function(a,b,d){var e,f,g,h=a.data,k=a.url,l=!1!==a.jsonp,n=l&&la.test(k),r=l&&!n&&"string"==typeof h&&!(a.contentType||"").indexOf("application/x-www-form-urlencoded")&&la.test(h);if("jsonp"===a.dataTypes[0]||n||r)return e=a.jsonpCallback=c.isFunction(a.jsonpCallback)?a.jsonpCallback():a.jsonpCallback,
f=s[e],n?a.url=k.replace(la,"$1"+e):r?a.data=h.replace(la,"$1"+e):l&&(a.url+=(Gc.test(k)?"&":"?")+a.jsonp+"="+e),a.converters["script json"]=function(){return g||c.error(e+" was not called"),g[0]},a.dataTypes[0]="json",s[e]=function(){g=arguments},d.always(function(){s[e]=f;a[e]&&(a.jsonpCallback=b.jsonpCallback,Bb.push(e));g&&c.isFunction(f)&&f(g[0]);g=f=p}),"script"});c.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},contents:{script:/javascript|ecmascript/},
converters:{"text script":function(a){return c.globalEval(a),a}}});c.ajaxPrefilter("script",function(a){a.cache===p&&(a.cache=!1);a.crossDomain&&(a.type="GET",a.global=!1)});c.ajaxTransport("script",function(a){if(a.crossDomain){var b,c=q.head||q.getElementsByTagName("head")[0]||q.documentElement;return{send:function(e,f){b=q.createElement("script");b.async="async";a.scriptCharset&&(b.charset=a.scriptCharset);b.src=a.url;b.onload=b.onreadystatechange=function(a,e){if(e||!b.readyState||/loaded|complete/.test(b.readyState))b.onload=
b.onreadystatechange=null,c&&b.parentNode&&c.removeChild(b),b=p,e||f(200,"success")};c.insertBefore(b,c.firstChild)},abort:function(){b&&b.onload(0,1)}}}});var K,za=s.ActiveXObject?function(){for(var a in K)K[a](0,1)}:!1,Ic=0;c.ajaxSettings.xhr=s.ActiveXObject?function(){var a;if(!(a=!this.isLocal&&Ta()))a:{try{a=new s.ActiveXObject("Microsoft.XMLHTTP");break a}catch(b){}a=void 0}return a}:Ta;(function(a){c.extend(c.support,{ajax:!!a,cors:!!a&&"withCredentials"in a})})(c.ajaxSettings.xhr());c.support.ajax&&
c.ajaxTransport(function(a){if(!a.crossDomain||c.support.cors){var b;return{send:function(d,e){var f,g,h=a.xhr();a.username?h.open(a.type,a.url,a.async,a.username,a.password):h.open(a.type,a.url,a.async);if(a.xhrFields)for(g in a.xhrFields)h[g]=a.xhrFields[g];a.mimeType&&h.overrideMimeType&&h.overrideMimeType(a.mimeType);a.crossDomain||d["X-Requested-With"]||(d["X-Requested-With"]="XMLHttpRequest");try{for(g in d)h.setRequestHeader(g,d[g])}catch(k){}h.send(a.hasContent&&a.data||null);b=function(d,
g){var k,m,q,s,v;try{if(b&&(g||4===h.readyState))if(b=p,f&&(h.onreadystatechange=c.noop,za&&delete K[f]),g)4!==h.readyState&&h.abort();else{k=h.status;q=h.getAllResponseHeaders();s={};(v=h.responseXML)&&v.documentElement&&(s.xml=v);try{s.text=h.responseText}catch(x){}try{m=h.statusText}catch(y){m=""}k||!a.isLocal||a.crossDomain?1223===k&&(k=204):k=s.text?200:404}}catch(z){g||e(-1,z)}s&&e(k,m,s,q)};a.async?4===h.readyState?setTimeout(b,0):(f=++Ic,za&&(K||(K={},c(s).unload(za)),K[f]=b),h.onreadystatechange=
b):b()},abort:function(){b&&b(0,1)}}}});var da,ma,Jc=/^(?:toggle|show|hide)$/,Kc=RegExp("^(?:([-+])=|)("+ia+")([a-z%]*)$","i"),Lc=/queueHooks$/,fa=[function(a,b,d){var e,f,g,h,k,l,n=this,p=a.style,m={},q=[],s=a.nodeType&&ba(a);d.queue||(k=c._queueHooks(a,"fx"),null==k.unqueued&&(k.unqueued=0,l=k.empty.fire,k.empty.fire=function(){k.unqueued||l()}),k.unqueued++,n.always(function(){n.always(function(){k.unqueued--;c.queue(a,"fx").length||k.empty.fire()})}));1===a.nodeType&&("height"in b||"width"in b)&&
(d.overflow=[p.overflow,p.overflowX,p.overflowY],"inline"===c.css(a,"display")&&"none"===c.css(a,"float")&&(c.support.inlineBlockNeedsLayout&&"inline"!==Na(a.nodeName)?p.zoom=1:p.display="inline-block"));d.overflow&&(p.overflow="hidden",c.support.shrinkWrapBlocks||n.done(function(){p.overflow=d.overflow[0];p.overflowX=d.overflow[1];p.overflowY=d.overflow[2]}));for(e in b)f=b[e],Jc.exec(f)&&(delete b[e],f!==(s?"hide":"show")&&q.push(e));if(f=q.length)for(g=c._data(a,"fxshow")||c._data(a,"fxshow",{}),
s?c(a).show():n.done(function(){c(a).hide()}),n.done(function(){var b;c.removeData(a,"fxshow",!0);for(b in m)c.style(a,b,m[b])}),e=0;e<f;e++)b=q[e],h=n.createTween(b,s?g[b]:0),m[b]=g[b]||c.style(a,b),b in g||(g[b]=h.start,s&&(h.end=h.start,h.start="width"===b||"height"===b?1:0))}],Z={"*":[function(a,b){var d,e,f=this.createTween(a,b),g=Kc.exec(b),h=f.cur(),k=+h||0,l=1,n=20;if(g){d=+g[2];e=g[3]||(c.cssNumber[a]?"":"px");if("px"!==e&&k){k=c.css(f.elem,a,!0)||d||1;do l=l||".5",k/=l,c.style(f.elem,a,
k+e);while(l!==(l=f.cur()/h)&&1!==l&&--n)}f.unit=e;f.start=k;f.end=g[1]?k+(g[1]+1)*d:d}return f}]};c.Animation=c.extend(Va,{tweener:function(a,b){c.isFunction(a)?(b=a,a=["*"]):a=a.split(" ");for(var d,e=0,f=a.length;e<f;e++)d=a[e],Z[d]=Z[d]||[],Z[d].unshift(b)},prefilter:function(a,b){b?fa.unshift(a):fa.push(a)}});c.Tween=C;C.prototype={constructor:C,init:function(a,b,d,e,f,g){this.elem=a;this.prop=d;this.easing=f||"swing";this.options=b;this.start=this.now=this.cur();this.end=e;this.unit=g||(c.cssNumber[d]?
...
e.complete=function(){c.isFunction(e.old)&&e.old.call(this);e.queue&&c.dequeue(this,e.queue)},e};c.easing={linear:function(a){return a},swing:function(a){return 0.5-Math.cos(a*Math.PI)/2}};c.timers=[];c.fx=C.prototype.init;c.fx.tick=function(){for(var a,b=c.timers,d=0;d<b.length;d++)a=b[d],!a()&&b[d]===a&&b.splice(d--,1);b.length||c.fx.stop()};c.fx.timer=function(a){a()&&c.timers.push(a)&&!ma&&(ma=setInterval(c.fx.tick,c.fx.interval))};c.fx.interval=13;c.fx.stop=function(){clearInterval(ma);ma=null};
...
b.document.documentElement["client"+a]:9===b.nodeType?(f=b.documentElement,Math.max(b.body["scroll"+a],f["scroll"+a],b.body["offset"+a],f["offset"+a],f["client"+a])):e===p?c.css(b,d,e,k):c.style(b,d,e,k)},b,h?e:p,h,null)}})});s.jQuery=s.$=c;"function"==typeof define&&define.amd&&define.amd.jQuery&&define("jquery",[],function(){return c})})(window);
